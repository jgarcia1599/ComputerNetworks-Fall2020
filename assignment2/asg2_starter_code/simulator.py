...
if __name__ == '__main__':
    ...
    # call plotting functions for each respective protocol
    if args.host_type == "Aimd":
      host.plot()
    if args.host_type == "SlidingWindow":
      print(f"After simulation, {host.originalpacketssent} original packets were sent and {host.originalpacketsreceived} of them were received ")
      print(f"After simulation, {host.retransmittedpactekssent} retransmitted packets were sent and {host.retransmittedpacteksreceived} of them were received ")