...
NUM_TICKS = 10000
'''
# Distance Vector Usage:
python3 simulator.py DV file_input --graph_file clique.graph
python3 simulator.py DV file_input --graph_file ring.graph
python3 simulator.py DV file_input --graph_file line.graph
python3 simulator.py DV file_input --graph_file midterm.graph
python3 simulator.py DV file_input --graph_file triangle.graph
python3 simulator.py DV rand_input --seed 1 --num_router 10 --link_prob 0.5
python3 simulator.py DV rand_input --seed 1 --num_router 100 --link_prob 0.5
python3 simulator.py DV rand_input --seed 2 --num_router 100 --link_prob 0.5
python3 simulator.py DV rand_input --seed 4 --num_router 100 --link_prob 0.5
# LS Usage:

python3 simulator.py LS file_input --graph_file clique.graph
python3 simulator.py LS file_input --graph_file ring.graph
python3 simulator.py LS file_input --graph_file line.graph
python3 simulator.py LS file_input --graph_file midterm.graph
python3 simulator.py LS file_input --graph_file triangle.graph
python3 simulator.py LS rand_input --seed 1 --num_router 100 --link_prob 0.5
python3 simulator.py LS rand_input --seed 2 --num_router 100 --link_prob 0.5
python3 simulator.py LS rand_input --seed 4 --num_router 100 --link_prob 0.5
python3 simulator.py LS rand_input --seed 7 --num_router 100 --link_prob 0.5
python3 simulator.py LS rand_input --seed 30 --num_router 100 --link_prob 0.5
python3 simulator.py LS rand_input --seed 90 --num_router 100 --link_prob 0.5
'''
